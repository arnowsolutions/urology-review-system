...
// Import routes
import applicantsRouter from '../backend/src/routes/applicants';
import reviewersRouter from '../backend/src/routes/reviewers';
import reviewsRouter from '../backend/src/routes/reviews';
import progressRouter from '../backend/src/routes/progress';

// Import CORS utilities
import { createCorsOptions, logCorsConfiguration } from '../backend/src/utils/corsConfig';

// Import environment utilities
import { getCurrentEnvironment, logEnvironmentInfo, getEnvironmentInfo } from '../backend/src/utils/environmentDetector';
